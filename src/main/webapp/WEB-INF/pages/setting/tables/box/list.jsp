...
<div>
    <a href="tables/box/preAdd">新增餐台</a>
    <table>
        <tr>
            <td>编号</td>
            <td>餐台名</td>
        ...
        <c:forEach var="tables" items="${listBox}">
            <tr>
                ...
                <td>${tables.minFee}</td>
                <td>
                    <a href="tables/box/preUpdate/${tables.tableId}">编辑餐台</a>
                    <a href="tables/box/delete/${tables.tableId}">删除餐台</a>
                </td>
            </tr>
        </c:forEach>
    </table>
