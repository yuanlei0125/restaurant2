...
<div class="am-g tpl-g">
    ...
    <div class="tpl-content-wrapper">
        <div>
            <span class="lin"><a href="tables/all/list">全部</a></span>
            <span class="lin"><a href="tables/hall/list">大厅</a></span>
            <span class="lin"><a href="tables/box/list">包厢</a></span>
        </div>
        <div>
            <div class="row">
                    ...
                    <div class="widget am-cf">
                        <div class="widget-body  widget-body-lg am-fr">
                            ...
                            <table id="ta" width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                <div>
                                    <span class="lin"> <a href="tables/all/preAdd">新增餐台</a></span>
                                    <table>
                                        <tr>
                                            <td>编号</td>
                                            <td>餐台名</td>
                                        ...
                                        <c:forEach var="tables" items="${listTables}">
                                            <tr>
                                                ...
                                                <td>${tables.minFee}</td>
                                                <td>
                                                    <a href="tables/all/preUpdate/${tables.tableId}">编辑餐台</a>
                                                    <a href="tables/all/delete/${tables.tableId}">删除餐台</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </table>
